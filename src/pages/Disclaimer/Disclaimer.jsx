            ...
            <div className="flex flex-col gap-[48px]">
              <div className="flex flex-col gap-[12px]">
                ...
                <p className="leading-[160%] pr-[24px]">
                  The information contained on Offer4Deal.in website (the
                  “Service”) is for general information purposes only.
                  Offer4Deal assumes no responsibility for errors or omissions
              ...
              <div className="flex flex-col gap-[12px]">
                ...
                <p className="leading-[160%] pr-[24px]">
                  In no event shall Offer4Deal.in be liable for any special,
                  ...
                  Offer4Deal.in reserves the right to make additions, deletions,
                  or modifications to the contents of the Service at any time
              ...
              <div className="flex flex-col gap-[12px]">
                ...
                <p className="leading-[160%] pr-[24px]">
                  Offer4Deal.in website might contain links to external websites
                  that are not provided or maintained by or in any way
                  affiliated with Offer4Deal.in. Please note that Offer4Deal.in
                  doesn’t guarantee the accuracy, relevance, timeliness, or
              ...
              <div className="flex flex-col gap-[12px]">
                ...
                <p className="leading-[160%] pr-[24px]">
                  Offer4Deal.in is a participant in the Amazon Services LLC
